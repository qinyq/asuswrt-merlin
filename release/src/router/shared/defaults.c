...
#ifdef EA9200
	{ "wl_ssid", "LINKSYS", 0 },		/* Service set ID (network name) */
	{ "wl1_ssid", "LINKSYS_5G-1", 0 },	/* Service set ID (network name) */
	{ "wl2_ssid", "LINKSYS_5G-2", 0 },	/* Service set ID (network name) */
#endif
...
#ifdef R8000
	{ "wl_ssid", "NETGEAR", 0 },		/* Service set ID (network name) */
	{ "wl1_ssid", "NETGEAR_5G-1", 0 },	/* Service set ID (network name) */
	{ "wl1_ssid", "NETGEAR_5G-2", 0 },	/* Service set ID (network name) */
#endif
#ifdef WS880
	{ "wl_ssid", "HUAWEI", 0 },		/* Service set ID (network name) */
	{ "wl1_ssid", "HUAWEI_5G", 0 },		/* Service set ID (network name) */
#endif
#else
...
#ifdef RTCONFIG_BCMWL6
	{ "acs_ifnames", "", 0 },
#if defined (RTAC68U) || defined (EA6900) || defined (R6300V2) || defined (R7000) || defined (WS880) || defined (RTAC66U) || defined (RTN66U) || defined (RTCONFIG_QTN) || defined (DSL_AC68U)
...
#ifdef R6300V2
struct nvram_tuple bcm4360ac_defaults[] = {
	{"pci/1/1/pa2gw1a0", "0x1A37" , 0},
	{"pci/1/1/pa2gw1a1", "0x1A0B" , 0},
	{"pci/1/1/pa2gw1a2", "0x19F2" , 0},
	{"pci/1/1/ledbh12", "11" , 0},
	{"pci/1/1/legofdmbw202gpo", "0xCA862222" , 0},
	{"pci/1/1/ag0", "0" , 0},
	{"pci/1/1/ag1", "0" , 0},
	{"pci/1/1/ag2", "0" , 0},
	{"pci/1/1/legofdmbw20ul2gpo", "0xCA862222" , 0},
	{"pci/1/1/rxchain", "7" , 0},
	{"pci/1/1/cckbw202gpo", "0" , 0},
	{"pci/1/1/mcsbw20ul2gpo", "0xCA862222" , 0},
	{"pci/1/1/pa2gw0a0", "0xFEB4" , 0},
	{"pci/1/1/pa2gw0a1", "0xFEBC" , 0},
	{"pci/1/1/pa2gw0a2", "0xFEA9" , 0},
	{"pci/1/1/boardflags", "0x80003200" , 0},
	{"pci/1/1/tempoffset", "0" , 0},
	{"pci/1/1/boardvendor", "0x14e4" , 0},
	{"pci/1/1/triso2g", "3" , 0},
	{"pci/1/1/sromrev", "9" , 0},
	{"pci/1/1/extpagain2g", "1" , 0},
	{"pci/1/1/venid", "0x14e4" , 0},
	{"pci/1/1/maxp2ga0", "0x66" , 0},
	{"pci/1/1/maxp2ga1", "0x66" , 0},
	{"pci/1/1/maxp2ga2", "0x66" , 0},
	{"pci/1/1/boardflags2", "0x4100000" , 0},
	{"pci/1/1/tssipos2g", "1" , 0},
	{"pci/1/1/ledbh0", "11" , 0},
	{"pci/1/1/ledbh2", "14" , 0},
	{"pci/1/1/ledbh3", "1" , 0},
	{"pci/1/1/mcs32po", "0x8" , 0},
	...
	{"pci/1/1/cckbw20ul2gpo", "0" , 0},
	{"pci/1/1/leddc", "0xFFFF" , 0},
	{"pci/1/1/pa2gw2a0", "0xF9EE" , 0},
	{"pci/1/1/pa2gw2a1", "0xFA05" , 0},
	{"pci/1/1/pa2gw2a2", "0xFA03" , 0},
	{"pci/1/1/xtalfreq", "20000" , 0},
	{"pci/1/1/ccode", "#a" , 0},
	{"pci/1/1/pdetrange2g", "3" , 0},
	{"pci/1/1/regrev", "0" , 0},
	{"pci/1/1/devid", "0x4332" , 0},
	{"pci/1/1/tempthresh", "120" , 0},
	{"pci/1/1/mcsbw402gpo", "0xECA86222" , 0},
	{"pci/1/1/mcsbw202gpo", "0xCA862222" , 0},

	{"pci/2/1/rxgains5ghtrisoa0", "5 ", 0},
	{"pci/2/1/rxgains5ghtrisoa1", "4 ", 0},
	{"pci/2/1/rxgains5ghtrisoa2", "4 ", 0},
	{"pci/2/1/txchain", "7 ", 0},
	{"pci/2/1/mcslr5gmpo", "0 ", 0},
	{"pci/2/1/phycal_tempdelta", "255 ", 0},
	{"pci/2/1/pdgain5g", "4 ", 0},
	{"pci/2/1/subband5gver", "0x4 ", 0},
	{"pci/2/1/ccode", "Q2 ", 0},
	{"pci/2/1/boardflags", "0x30000000 ", 0},
	{"pci/2/1/tworangetssi5g", "0 ", 0},
	{"pci/2/1/sb20in40hrpo", "0 ", 0},
	{"pci/2/1/rxgains5gtrisoa0", "7 ", 0},
	{"pci/2/1/rxgains5gtrisoa1", "6 ", 0},
	{"pci/2/1/tempoffset", "255 ", 0},
	{"pci/2/1/rxgains5gtrisoa2", "5 ", 0},
	{"pci/2/1/mcsbw205gmpo", "0xECA86400 ", 0},
	{"pci/2/1/noiselvl5ga0", "31,31,31,31 ", 0},
	{"pci/2/1/noiselvl5ga1", "31,31,31,31 ", 0},
	{"pci/2/1/noiselvl5ga2", "31,31,31,31 ", 0},
	{"pci/2/1/xtalfreq", "40000 ", 0},
	{"pci/2/1/tempsense_option", "0x3 ", 0},
	{"pci/2/1/devid", "0x43a2 ", 0},
	{"pci/2/1/femctrl", "3 ", 0},
	{"pci/2/1/aa5g", "7 ", 0},
	{"pci/2/1/pdoffset80ma0", "0 ", 0},
	{"pci/2/1/pdoffset80ma1", "0 ", 0},
	{"pci/2/1/papdcap5g", "0 ", 0},
	{"pci/2/1/pdoffset80ma2", "0 ", 0},
	{"pci/2/1/tssiposslope5g", "1 ", 0},
	{"pci/2/1/tempcorrx", "0x3f ", 0},
	{"pci/2/1/mcslr5glpo", "0 ", 0},
	{"pci/2/1/sar5g", "15 ", 0},
	{"pci/2/1/pa5ga0", "0xFF39,0x1A55,0xFCC7,0xFF50,0x1AD0,0xFCE0,0xFF50,0x1B6F,0xFCD0,0xFF58,0x1BB9,0xFCD0 ", 0},
	{"pci/2/1/rxgains5gmelnagaina0", "2 ", 0},
	{"pci/2/1/pa5ga1", "0xFF36,0x1AAD,0xFCBD,0xFF50,0x1AF7,0xFCE0,0xFF50,0x1B5B,0xFCD8,0xFF58,0x1B8F,0xFCD0 ", 0},
	{"pci/2/1/rxgains5gmelnagaina1", "2 ", 0},
	{"pci/2/1/pa5ga2", "0xFF40,0x1A1F,0xFCDA,0xFF48,0x1A5D,0xFCE8,0xFF35,0x1A2D,0xFCCA,0xFF3E,0x1A2B,0xFCD0 ", 0},
	{"pci/2/1/rxgains5gmelnagaina2", "3 ", 0},
	{"pci/2/1/mcslr5ghpo", "0 ", 0},
	{"pci/2/1/rxgainerr5ga0", "63,63,63,63 ", 0},
	{"pci/2/1/rxgainerr5ga1", "31,31,31,31 ", 0},
	{"pci/2/1/rxgainerr5ga2", "31,31,31,31 ", 0},
	{"pci/2/1/pdoffset40ma0", "4369 ", 0},
	{"pci/2/1/pcieingress_war", "15 ", 0},
	{"pci/2/1/pdoffset40ma1", "4369 ", 0},
	{"pci/2/1/pdoffset40ma2", "4369 ", 0},
	{"pci/2/1/sb40and80lr5gmpo", "0 ", 0},
	{"pci/2/1/rxgains5gelnagaina0", "1 ", 0},
	{"pci/2/1/rxgains5gelnagaina1", "1 ", 0},
	{"pci/2/1/rxgains5gelnagaina2", "1 ", 0},
	{"pci/2/1/agbg0", "71 ", 0},
	{"pci/2/1/agbg1", "71 ", 0},
	{"pci/2/1/mcsbw205glpo", "0xECA86400 ", 0},
	{"pci/2/1/agbg2", "133 ", 0},
	{"pci/2/1/measpower1", "0x7f ", 0},
	{"pci/2/1/measpower2", "0x7f ", 0},
	{"pci/2/1/sb20in80and160lr5gmpo", "0 ", 0},
	{"pci/2/1/temps_period", "15 ", 0},
	{"pci/2/1/mcsbw805gmpo", "0xFEA86400 ", 0},
	{"pci/2/1/dot11agduplrpo", "0 ", 0},
	{"pci/2/1/mcsbw205ghpo", "0xECA86400 ", 0},
	{"pci/2/1/measpower", "0x7f ", 0},
	{"pci/2/1/rxgains5ghelnagaina0", "2 ", 0},
	{"pci/2/1/rxgains5ghelnagaina1", "2 ", 0},
	{"pci/2/1/rxgains5ghelnagaina2", "3 ", 0},
	{"pci/2/1/gainctrlsph", "0 ", 0},
	{"pci/2/1/sb40and80hr5gmpo", "0 ", 0},
	{"pci/2/1/mcsbw1605gmpo", "0 ", 0},
	{"pci/2/1/sb20in80and160hr5gmpo", "0 ", 0},
	{"pci/2/1/epagain5g", "0 ", 0},
	{"pci/2/1/mcsbw405gmpo", "0xECA86400 ", 0},
	{"pci/2/1/boardtype", "0x621 ", 0},
	{"pci/2/1/rxchain", "7 ", 0},
	{"pci/2/1/sb40and80lr5glpo", "0 ", 0},
	{"pci/2/1/maxp5ga0", "102,102,102,102 ", 0},
	{"pci/2/1/maxp5ga1", "102,102,102,102 ", 0},
	{"pci/2/1/maxp5ga2", "102,102,102,102 ", 0},
	{"pci/2/1/sb20in80and160lr5glpo", "0 ", 0},
	{"pci/2/1/sb40and80lr5ghpo", "0 ", 0},
	{"pci/2/1/venid", "0x14e4 ", 0},
	{"pci/2/1/mcsbw805glpo", "0xFEA86400 ", 0},
	{"pci/2/1/boardvendor", "0x14e4 ", 0},
	{"pci/2/1/tempsense_slope", "0xff ", 0},
	{"pci/2/1/sb20in80and160lr5ghpo", "0 ", 0},
	{"pci/2/1/antswitch", "0 ", 0},
	{"pci/2/1/mcsbw805ghpo", "0xFEA86400 ", 0},
	{"pci/2/1/aga0", "71 ", 0},
	{"pci/2/1/aga1", "133 ", 0},
	{"pci/2/1/aga2", "133 ", 0},
	{"pci/2/1/rawtempsense", "0x1ff ", 0},
	{"pci/2/1/tempthresh", "255 ", 0},
	{"pci/2/1/dot11agduphrpo", "0 ", 0},
	{"pci/2/1/sb40and80hr5glpo", "0 ", 0},
	{"pci/2/1/sromrev", "11 ", 0},
	{"pci/2/1/boardnum", "20771 ", 0},
	{"pci/2/1/sb20in40lrpo", "0 ", 0},
	{"pci/2/1/mcsbw1605glpo", "0 ", 0},
	{"pci/2/1/sb20in80and160hr5glpo", "0 ", 0},
	{"pci/2/1/sb40and80hr5ghpo", "0 ", 0},
	{"pci/2/1/mcsbw405glpo", "0xECA86400 ", 0},
	{"pci/2/1/boardrev", "0x1402 ", 0},
	{"pci/2/1/mcsbw1605ghpo", "0 ", 0},
	{"pci/2/1/sb20in80and160hr5ghpo", "0 ", 0},
	{"pci/2/1/rxgains5gmtrisoa0", "5 ", 0},
	{"pci/2/1/rxgains5gmtrisoa1", "4 ", 0},
	{"pci/2/1/rxgains5gmtrisoa2", "4 ", 0},
	{"pci/2/1/rxgains5gmtrelnabypa0", "1 ", 0},
	{"pci/2/1/rxgains5gmtrelnabypa1", "1 ", 0},
	{"pci/2/1/mcsbw405ghpo", "0xECA86400 ", 0},
	{"pci/2/1/rxgains5gmtrelnabypa2", "1 ", 0},
	{"pci/2/1/boardflags2", "0x300002 ", 0},
	{"pci/2/1/boardflags3", "0x0 ", 0},
	{"pci/2/1/rxgains5ghtrelnabypa0", "1 ", 0},
	{"pci/2/1/rxgains5ghtrelnabypa1", "1 ", 0},
	{"pci/2/1/regrev", "12 ", 0},
	{"pci/2/1/rxgains5ghtrelnabypa2", "1 ", 0},
	{"pci/2/1/temps_hysteresis", "15 ", 0},
	{"pci/2/1/rxgains5gtrelnabypa0", "1 ", 0},
	{"pci/2/1/rxgains5gtrelnabypa1", "1 ", 0},
...
struct nvram_tuple bcm4360ac_defaults[] = {
	...
	{ "pci/1/1/agbg2", "71", 0 },
	{ "pci/1/1/antswitch", "0", 0 },
	{ "pci/1/1/boardflags", "0x00001000", 0 },
	{ "pci/1/1/boardflags2", "0x00100002", 0 },
	{ "pci/1/1/boardflags3", "0x10000003", 0 },
	{ "pci/1/1/boardnum", "57359", 0 },
	{ "pci/1/1/boardrev", "0x1150", 0 },
	{ "pci/1/1/boardtype", "0x661", 0 },
	{ "pci/1/1/cckbw202gpo", "0", 0 },
	{ "pci/1/1/cckbw20ul2gpo", "0", 0 },
	{ "pci/1/1/ccode", "#a", 0 },
	{ "pci/1/1/devid", "0x43A1", 0 },
	{ "pci/1/1/dot11agduphrpo", "0", 0 },
	{ "pci/1/1/dot11agduplrpo", "0", 0 },
	{ "pci/1/1/dot11agofdmhrbw202gpo", "0xCA86", 0 },
	{ "pci/1/1/epagain2g", "0", 0 },
	{ "pci/1/1/femctrl", "3", 0 },
	{ "pci/1/1/gainctrlsph", "0", 0 },
	{ "pci/1/1/maxp2ga0", "106", 0 },
	{ "pci/1/1/maxp2ga1", "106", 0 },
	{ "pci/1/1/maxp2ga2", "106", 0 },
	{ "pci/1/1/mcsbw202gpo", "0xA976A600", 0 },
	{ "pci/1/1/mcsbw402gpo", "0xA976A600", 0 },
	{ "pci/1/1/measpower1", "0x7F", 0 },
	{ "pci/1/1/measpower2", "0x7F", 0 },
	{ "pci/1/1/measpower", "0x7F", 0 },
	{ "pci/1/1/noiselvl2ga0", "31", 0 },
	{ "pci/1/1/noiselvl2ga1", "31", 0 },
	{ "pci/1/1/noiselvl2ga2", "31", 0 },
	{ "pci/1/1/ofdmlrbw202gpo", "0", 0 },
	{ "pci/1/1/pa2ga0", "0xFF32,0x1C30,0xFCA3", 0 },
	{ "pci/1/1/pa2ga1", "0xFF35,0x1BE3,0xFCB0", 0 },
	{ "pci/1/1/pa2ga2", "0xFF33,0x1BE1,0xFCB0", 0 },
	{ "pci/1/1/papdcap2g", "0", 0 },
	{ "pci/1/1/pdgain2g", "14", 0 },
	{ "pci/1/1/pdoffset2g40ma0", "15", 0 },
	{ "pci/1/1/pdoffset2g40ma1", "15", 0 },
	{ "pci/1/1/pdoffset2g40ma2", "15", 0 },
	{ "pci/1/1/pdoffset2g40mvalid", "1", 0 },
	{ "pci/1/1/pdoffset40ma0", "0", 0 },
	{ "pci/1/1/pdoffset40ma1", "0", 0 },
	{ "pci/1/1/pdoffset40ma2", "0", 0 },
	{ "pci/1/1/pdoffset80ma0", "0", 0 },
	{ "pci/1/1/pdoffset80ma1", "0", 0 },
	{ "pci/1/1/pdoffset80ma2", "0", 0 },
	{ "pci/1/1/pwr_scale_1db", "1", 0 },
	{ "pci/1/1/regrev", "0", 0 },
	{ "pci/1/1/rxgainerr2ga0", "63", 0 },
	{ "pci/1/1/rxgainerr2ga1", "31", 0 },
	{ "pci/1/1/rxgainerr2ga2", "31", 0 },
	{ "pci/1/1/rxgains2gelnagaina0", "3", 0 },
	{ "pci/1/1/rxgains2gelnagaina1", "3", 0 },
	{ "pci/1/1/rxgains2gelnagaina2", "3", 0 },
	{ "pci/1/1/rxgains2gtrelnabypa0", "1", 0 },
	{ "pci/1/1/rxgains2gtrelnabypa1", "1", 0 },
	{ "pci/1/1/rxgains2gtrelnabypa2", "1", 0 },
	{ "pci/1/1/rxgains2gtrisoa0", "7", 0 },
	{ "pci/1/1/rxgains2gtrisoa1", "7", 0 },
	{ "pci/1/1/rxgains2gtrisoa2", "7", 0 },
	{ "pci/1/1/sar2g", "18", 0 },
	{ "pci/1/1/sromrev", "11", 0 },
	{ "pci/1/1/subband5gver", "4", 0 },
	{ "pci/1/1/subvid", "0x14E4", 0 },
	{ "pci/1/1/tssifloor2g", "0x3FF", 0 },
	{ "pci/1/1/tssiposslope2g", "1", 0 },
	{ "pci/1/1/tworangetssi2g", "0", 0 },
	{ "pci/1/1/xtalfreq", "65535", 0 },
	{ "pci/2/1/aa2g", "7", 0 },
	{ "pci/2/1/aa5g", "0", 0 },
	{ "pci/2/1/aga0", "0", 0 },
	{ "pci/2/1/aga1", "0", 0 },
	...
	{ "pci/2/1/antswitch", "0", 0 },
	{ "pci/2/1/boardflags", "0x30000000", 0 },
	{ "pci/2/1/boardflags2", "0x00300002", 0 },
	{ "pci/2/1/boardflags3", "0x10000000", 0 },
	{ "pci/2/1/boardnum", "20507", 0 },
	{ "pci/2/1/boardrev", "0x1451", 0 },
	{ "pci/2/1/boardtype", "0x621", 0 },
	{ "pci/2/1/cckbw202gpo", "0", 0 },
	{ "pci/2/1/cckbw20ul2gpo", "0", 0 },
	{ "pci/2/1/ccode", "#a", 0 },
	...
	{ "pci/2/1/maxp2ga1", "76", 0 },
	{ "pci/2/1/maxp2ga2", "76", 0 },
	{ "pci/2/1/maxp5ga0", "106,106,106,106", 0 },
	{ "pci/2/1/maxp5ga1", "106,106,106,106", 0 },
	{ "pci/2/1/maxp5ga2", "106,106,106,106", 0 },
	{ "pci/2/1/mcsbw1605ghpo", "0", 0 },
	{ "pci/2/1/mcsbw1605glpo", "0", 0 },
	{ "pci/2/1/mcsbw1605gmpo", "0", 0 },
	{ "pci/2/1/mcsbw1605hpo", "0", 0 },
	{ "pci/2/1/mcsbw202gpo", "0", 0 },
	{ "pci/2/1/mcsbw205ghpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw205glpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw205gmpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw402gpo", "0", 0 },
	{ "pci/2/1/mcsbw405ghpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw405glpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw405gmpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw805ghpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw805glpo", "0xBA768600", 0 },
	{ "pci/2/1/mcsbw805gmpo", "0xBA768600", 0 },
	{ "pci/2/1/mcslr5ghpo", "0", 0 },
	{ "pci/2/1/mcslr5glpo", "0", 0 },
	{ "pci/2/1/mcslr5gmpo", "0", 0 },
	{ "pci/2/1/measpower1", "0x7F", 0 },
	...
	{ "pci/2/1/pa2ga1", "0xFE80,0x1472,0xFABC", 0 },
	{ "pci/2/1/pa2ga2", "0xFE82,0x14BF,0xFAD9", 0 },
	{ "pci/2/1/pa5ga0", "0xFF4C,0x1808,0xFD1B,0xFF4C,0x18CF,0xFD0C,0xFF4A,0x1920,0xFD08,0xFF4C,0x1949,0xFCF6", 0 },
	{ "pci/2/1/pa5ga1", "0xFF4A,0x18AC,0xFD0B,0xFF44,0x1904,0xFCFF,0xFF56,0x1A09,0xFCFC,0xFF4F,0x19AB,0xFCEF", 0 },
	{ "pci/2/1/pa5ga2", "0xFF4C,0x1896,0xFD11,0xFF43,0x192D,0xFCF5,0xFF50,0x19EE,0xFCF1,0xFF52,0x19C6,0xFCF1", 0 },
	{ "pci/2/1/papdcap2g", "0", 0 },
	{ "pci/2/1/papdcap5g", "0", 0 },
	{ "pci/2/1/pdgain2g", "4", 0 },
	{ "pci/2/1/pdgain5g", "4", 0 },
	{ "pci/2/1/pdoffset2g40ma0", "15", 0 },
	{ "pci/2/1/pdoffset2g40ma1", "15", 0 },
	{ "pci/2/1/pdoffset2g40ma2", "15", 0 },
	{ "pci/2/1/pdoffset2g40mvalid", "1", 0 },
	{ "pci/2/1/pdoffset40ma0", "4369", 0 },
	{ "pci/2/1/pdoffset40ma1", "4369", 0 },
	{ "pci/2/1/pdoffset40ma2", "4369", 0 },
	{ "pci/2/1/pdoffset80ma0", "0", 0 },
	...
	{ "pci/2/1/pdoffset80ma2", "0", 0 },
	{ "pci/2/1/phycal_tempdelta", "255", 0 },
	{ "pci/2/1/pwr_scale_1db", "1", 0 },
	{ "pci/2/1/rawtempsense", "0x1FF", 0 },
	{ "pci/2/1/regrev", "0", 0 },
	{ "pci/2/1/rpcal2g", "0", 0 },
	{ "pci/2/1/rxchain", "7", 0 },
	{ "pci/2/1/rxgainerr2ga0", "63", 0 },
	{ "pci/2/1/rxgainerr2ga1", "31", 0 },
	{ "pci/2/1/rxgainerr2ga2", "31", 0 },
	{ "pci/2/1/rxgainerr5ga0", "63,63,63,63", 0 },
	{ "pci/2/1/rxgainerr5ga1", "31,31,31,31", 0 },
	{ "pci/2/1/rxgainerr5ga2", "31,31,31,31", 0 },
	{ "pci/2/1/rxgains2gelnagaina0", "0", 0 },
	...
	{ "pci/2/1/rxgains2gtrisoa1", "0", 0 },
	{ "pci/2/1/rxgains2gtrisoa2", "0", 0 },
	{ "pci/2/1/rxgains5gelnagaina0", "4", 0 },
	{ "pci/2/1/rxgains5gelnagaina1", "4", 0 },
	{ "pci/2/1/rxgains5gelnagaina2", "4", 0 },
	{ "pci/2/1/rxgains5ghelnagaina0", "3", 0 },
	{ "pci/2/1/rxgains5ghelnagaina1", "3", 0 },
	{ "pci/2/1/rxgains5ghelnagaina2", "4", 0 },
	{ "pci/2/1/rxgains5ghtrelnabypa0", "1", 0 },
	{ "pci/2/1/rxgains5ghtrelnabypa1", "1", 0 },
	{ "pci/2/1/rxgains5ghtrelnabypa2", "1", 0 },
	{ "pci/2/1/rxgains5ghtrisoa0", "5", 0 },
	{ "pci/2/1/rxgains5ghtrisoa1", "4", 0 },
	{ "pci/2/1/rxgains5ghtrisoa2", "4", 0 },
	{ "pci/2/1/rxgains5gmelnagaina0", "3", 0 },
	{ "pci/2/1/rxgains5gmelnagaina1", "4", 0 },
	{ "pci/2/1/rxgains5gmelnagaina2", "4", 0 },
	{ "pci/2/1/rxgains5gmtrelnabypa0", "1", 0 },
	{ "pci/2/1/rxgains5gmtrelnabypa1", "1", 0 },
	{ "pci/2/1/rxgains5gmtrelnabypa2", "1", 0 },
	{ "pci/2/1/rxgains5gmtrisoa0", "5", 0 },
	...
	{ "pci/2/1/sb40and80lr5gmpo", "0", 0 },
	{ "pci/2/1/sromrev", "11", 0 },
	{ "pci/2/1/subband5gver", "4", 0 },
	{ "pci/2/1/subvid", "0x14E4", 0 },
	{ "pci/2/1/tempcorrx", "0x3F", 0 },
	{ "pci/2/1/tempoffset", "255", 0 },
	{ "pci/2/1/temps_hysteresis", "15", 0 },
	{ "pci/2/1/temps_period", "15", 0 },
	{ "pci/2/1/tempsense_option", "3", 0 },
	{ "pci/2/1/tempsense_slope", "255", 0 },
	{ "pci/2/1/tempthresh", "255", 0 },
	{ "pci/2/1/tssifloor2g", "0x3FF", 0 },
	{ "pci/2/1/tssifloor5g", "0x3FF,0x3FF,0x3FF,0x3FF", 0 },
	{ "pci/2/1/tssiposslope2g", "1", 0 },
	{ "pci/2/1/tssiposslope5g", "1", 0 },
	{ "pci/2/1/tworangetssi2g", "0", 0 },
	{ "pci/2/1/tworangetssi5g", "0", 0 },
	{ "pci/2/1/txchain", "7", 0 },
	{ "pci/2/1/xtalfreq", "65535", 0 },
	{ 0, 0, 0 }
};
#endif
#ifdef R8000
...
struct nvram_tuple bcm4360ac_defaults[] = {
	...
	{ "0:boardvendor", "0x14E4", 0 },
	{ "0:sromrev", "9", 0 },
	{ "0:boardflags", "0x80001200", 0 },
	{ "0:boardflags2", "0x00100000", 0 },
	{ "0:xtalfreq", "20000", 0 },
	{ "0:devid", "0x4332", 0 },
	{ "0:aa2g", "7", 0 },
	{ "0:ag0", "0", 0 },
	...
	{ "0:cckbw202gpo", "0", 0 },
	{ "0:cckbw20ul2gpo", "0", 0 },
	{ "0:legofdmbw202gpo", "0x88888888", 0 },
	{ "0:legofdmbw20ul2gpo", "0x88888888", 0 },
	{ "0:mcsbw202gpo", "0x88888888", 0 },
	{ "0:mcsbw20ul2gpo", "0x88888888", 0 },
	{ "0:mcsbw402gpo", "0x88888888", 0 },
	{ "0:mcs32po", "0", 0 },
	{ "0:legofdm40duppo", "0", 0 },
	{ "0:parefldovoltage", "35", 0 },
	{ "0:ccode", "#a", 0 },
	{ "0:regrev", "0", 0 },
	{ "0:temps_period", "5", 0 },
	{ "0:tempthresh", "120", 0 },
	...
	{ "1:maxp5ga0", "70,70,86,86", 0 },
	{ "1:pa5ga0", "0xff31,0x1a56,0xfcc7,0xff35,0x1a8f,0xfcc1,0xff35,0x18d4,0xfcf4,0xff2d,0x18d5,0xfce8", 0 },
	{ "1:maxp5ga1", "70,70,86,86", 0 },
	{ "1:pa5ga1", "0xff30,0x190f,0xfce6,0xff38,0x1abc,0xfcc0,0xff0f,0x1762,0xfcef,0xff18,0x1648,0xfd23", 0 },
	{ "1:maxp5ga2", "70,70,86,86", 0 },
	{ "1:pa5ga2", "0xff32,0x18f6,0xfce8,0xff36,0x195d,0xfcdf,0xff28,0x16ae,0xfd1e,0xff28,0x166c,0xfd2b", 0 },
	{ "1:pdoffset40ma0", "0x1111", 0 },
	{ "1:pdoffset40ma1", "0x1111", 0 },
	{ "1:pdoffset40ma2", "0x1111", 0 },
	{ "1:pdoffset80ma0", "0", 0 },
	{ "1:pdoffset80ma1", "0", 0 },
	{ "1:pdoffset80ma2", "0xfecc", 0 },
	{ "1:mcsbw205glpo", "0x66666666", 0 },
	{ "1:mcsbw405glpo", "0x22222222", 0 },
	{ "1:mcsbw805glpo", "0x00222222", 0 },
	{ "1:mcsbw1605glpo", "0x00222222", 0 },
	{ "1:mcsbw205gmpo", "0x66666666", 0 },
	{ "1:mcsbw405gmpo", "0x22222222", 0 },
	{ "1:mcsbw805gmpo", "0x00222222", 0 },
	{ "1:mcsbw1605gmpo", "0", 0 },
	{ "1:mcsbw205ghpo", "0xaa880000", 0 },
	{ "1:mcsbw405ghpo", "0xaa880000", 0 },
	{ "1:mcsbw805ghpo", "0x88880000", 0 },
	{ "1:mcsbw1605ghpo", "0", 0 },
	{ "1:mcslr5glpo", "0", 0 },
	{ "1:mcslr5gmpo", "0", 0 },
	{ "1:mcslr5ghpo", "0", 0 },
	...
	{ "1:dot11agduphrpo", "0", 0 },
	{ "1:dot11agduplrpo", "0", 0 },
	{ "1:rpcal5gb0", "0xffff", 0 },
	{ "1:rpcal5gb1", "0xffff", 0 },
	{ "1:rpcal5gb2", "0xffff", 0 },
	{ "1:rpcal5gb3", "0xffff", 0 },
	{ "1:measpower", "0x7f", 0 },
	{ "1:measpower1", "0x7f", 0 },
	{ "1:measpower2", "0x7f", 0 },
	{ "1:ccode", "#a", 0 },
