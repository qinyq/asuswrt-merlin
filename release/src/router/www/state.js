...
tablink[10] = new Array("", "Main_Analysis_Content.asp", "Main_Netstat_Content.asp", "Main_WOL_Content.asp", "Main_Ss_Content.asp", "SMTP_Client.asp", "Advanced_Smart_Connect.asp");
if(bwdpi_support){
	if(based_modelid == "RT-AC3200"){
