...
export VTX_BASE6 := $(filter-out RTAC68U=y BWDPI=y DEBUGFS=y CLOUDSYNC=y JFFS2LOG=y DUMP_OOPS_MSG=y TURBO=y LINUX_MTD="64",$(RT-AC68U_BASE))
export VTX_BASE6 += XWRT=y DEBUGFS=n JFFS2LOG=n LINUX_MTD="32"

export EA6900 := $(filter-out LED_BTN=y LED_BTN_MODE=y,$(VTX_BASE6))
export EA6900 += BUILD_NAME="EA6900"
export R6300V2  := $(VTX_BASE6)
export R6300V2  += BUILD_NAME="R6300V2" LANWAN_LED=y WLAN_LED=y WANRED_LED=y TURBO=y NETGEAR_CHK=y BOARD_FILE="compatible_r6300v2.txt" FW_FILE="ambitCfg-r6300v2.h"
export R7000  := $(VTX_BASE6)
export R7000  += BUILD_NAME="R7000" LANWAN_LED=y WLAN_LED=y WANRED_LED=y TURBO=y NETGEAR_CHK=y BOARD_FILE="compatible_r7000.txt" FW_FILE="ambitCfg-r7000.h"
export WS880  := $(VTX_BASE6)
export WS880  += BUILD_NAME="WS880" LANWAN_LED=y WLAN_LED=y WANRED_LED=y
...
export VTX_BASE7 := $(filter-out BUILD_NAME="RT-AC3200" RTAC3200=y JFFS2LOG=y LINUX_MTD="64" APP="installed",$(RT-AC3200))
export VTX_BASE7 += XWRT=y JFFS2LOG=n LINUX_MTD="32" APP="nolocaldm"

export EA9200 := $(filter-out LED_BTN=y LED_BTN_MODE=y,$(VTX_BASE7))
export EA9200 += BUILD_NAME="EA9200"
export R8000  := $(VTX_BASE7)
export R8000  += BUILD_NAME="R8000" LANWAN_LED=y WLAN_LED=y WANRED_LED=y TURBO=y NETGEAR_CHK=y BOARD_FILE="compatible_r8000.txt" FW_FILE="ambitCfg-r8000.h"
